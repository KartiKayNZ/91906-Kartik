...
class EnemyCharacter(arcade.Sprite):
    ...
    def __init__(self, x, y):
        ...
        main_path = "assets/enemy_sprites/enemy"
        self.idle_textures = []
        for i in range(4):
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Add enemy sprites
        enemy_sprite = EnemyCharacter(1000, 500)
    ...
    def on_update(self, delta_time):
        ...
        for enemy in self.scene["Enemies"]:
            enemy.change_x = self.player_sprite.center_x - enemy.center_x
            enemy.change_y = self.player_sprite.center_y - enemy.center_y
            enemy.update()
